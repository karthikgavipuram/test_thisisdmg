...
This repository has set of ansible playbooks created to setup a kubernetes cluster fully automated with one master and multiple worker nodes. 
...
6. There is a file "hosts" available in "test-ansible" directory, Just make your entries of your all kubernetes nodes. 
